...
<body>
  <div class="card">
    ...
    <div class="perms">
      ...
      <div class="perm"><span class="check">✓</span> 查看手机主动上报的设备、今日步数、位置和天气状态（只读）</div>
...
<body>
  ...
  <div class="tool"><span class="tool-name">get_device_status</span><span class="tool-desc">查看手机最近主动上报的电量、今日步数、定位、天气、App 使用动态与数据新鲜度</span></div>
