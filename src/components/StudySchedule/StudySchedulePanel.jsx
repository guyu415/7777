  ...
  return createPortal((
    <div className="study-schedule" role="dialog" aria-modal="true" aria-label="半月课表">
      ...
      <style>{`
        ...
        .study-schedule__cell{min-width:0;margin:3px 5px;padding:0 4px;display:flex;align-items:center;justify-content:center;border:0;border-radius:11px;background:transparent;color:rgba(169,153,160,.58)}.study-schedule__cell span{display:block;max-width:100%;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;font:500 clamp(10px,2.8vw,12px)/1 'ZCOOL XiaoWei',serif}.study-schedule__cell.has-course{transform:translateY(clamp(-11px,-.85dvh,-6px));box-shadow:inset 0 0 0 1px rgba(255,255,255,.5),0 1px 4px rgba(121,103,110,.06)}.study-schedule__cell strong{font-weight:600}
