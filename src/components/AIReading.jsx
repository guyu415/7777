  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        .ai-reading__selection-tools { position: fixed; z-index: 7; right: max(12px, env(safe-area-inset-right)); bottom: calc(104px + var(--safe-bottom)); left: max(12px, env(safe-area-inset-left)); box-sizing: border-box; width: auto; max-width: 330px; margin-inline: auto; display: grid; gap: 7px; padding: 9px 10px; border: 1px solid rgba(255,255,255,.67); border-radius: 16px; color: #706f75; background: rgba(255,253,251,.89); box-shadow: 0 10px 28px rgba(74,66,78,.16); backdrop-filter: blur(16px); -webkit-backdrop-filter: blur(16px); animation: ai-reading-selection-in 160ms ease-out both; }
        ...
        @keyframes ai-reading-selection-in { from { opacity: 0; transform: translateY(5px) scale(.98); } to { opacity: 1; transform: translateY(0) scale(1); } }
        @keyframes ai-reading-sheet-in { from { opacity: 0; transform: translateY(100%); } to { opacity: 1; transform: translateY(0); } }
        @media (prefers-reduced-motion: reduce) { .ai-reading__status-dot, .ai-reading__paragraph.is-reading, .ai-reading__reading-caret, .ai-reading__sheet, .ai-reading__floating-locate, .ai-reading__selection-tools { animation: none; } .ai-reading__body { scroll-behavior: auto; } }
