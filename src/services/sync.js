...
const SYNC_KEYS = [
  ...
  'themeId', 'bubbleSkin', 'userBubbleTextColor', 'chatBg', 'fontFamily', 'defaultFontSize', 'customFonts',
  ...
  'acWorkerUrl',
  'readingState', 'readingSessions', 'pendingReadingRequest', 'readingBookStates',
  'desktopPet',
]
