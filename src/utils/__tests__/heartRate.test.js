...
describe('heart-rate tool effect', () => {
  it('recognizes current watch reads without treating every health query as heart rate', () => {
    expect(isHeartRateTool('health_latest')).toBe(true)
    expect(isHeartRateTool('mcp__apple_health__health_current_context')).toBe(true)
